...
var lyr_TM_2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'TM<br />\
    <img src="styles/legend/TM_2_0.png" /> Районы по которым<br>обследование почв<br>не проводилось<br />\
    <img src="styles/legend/TM_2_1.png" /> Районы по которым<br>проведено обследование<br>почв<br />'
        });
...
lyr_K_0.setVisible(true);lyr_C_1.setVisible(false);lyr_TM_2.setVisible(false);lyr_P_3.setVisible(true);
var layersList = [lyr_K_0,lyr_C_1,lyr_TM_2,lyr_P_3];
